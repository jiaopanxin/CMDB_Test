...
# def process_data():
#     inventory_obj= Invertory_group.objects.all()
#     for group in inventory_obj:
#         print(group)
...
inv_path = "/home/alice/项目/jpx/auto_cmdb/auto_cmdb/octoups/inventory/hosts"
...
class MyAnsiable2():
    ...
    # 执行ansible的函数
    def run(self, hosts='localhost', gether_facts="no", module="shell", args='ls'):
        play_source = dict(
            name="Ad-hoc",
            hosts=hosts,
...
if __name__ == "__main__":
    myansible = MyAnsiable2(
        connection="smart", remote_user="stus", inventory=inv_path)

    myansible.run(hosts="all",module="ping",args="")
    myansible.get_result()
