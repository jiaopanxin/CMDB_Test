# Generated by Django 2.1.5 on 2019-10-31 03:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.CharField(max_length=64, verbose_name='连接用户名')),
                ('password', models.CharField(max_length=512, verbose_name='连接用户密码')),
                ('port', models.PositiveIntegerField(verbose_name='sshd的监听端口')),
                ('auth', models.BooleanField(default=False, help_text='是否建立了基于密钥的信任关系', verbose_name='是否认证')),
            ],
            options={
                'verbose_name': '服务器连接表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slot_number', models.CharField(max_length=128, null=True, verbose_name='插槽')),
                ('pd_type', models.CharField(max_length=128, null=True, verbose_name='类型')),
                ('raw_size', models.CharField(max_length=128, null=True, verbose_name='大小')),
            ],
            options={
                'verbose_name': '硬盘信息表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manager_ip', models.GenericIPAddressField(blank=True, default='10.0.122.188', null=True, verbose_name='IP地址')),
                ...
                ('cpu_model', models.CharField(max_length=128, verbose_name='cpu名称')),
                ('cpu_type', models.CharField(max_length=128, verbose_name='cpu类型')),
                ('cpu_num', models.IntegerField(verbose_name='cpu物理颗数')),
